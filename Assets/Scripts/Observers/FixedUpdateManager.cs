...
{
    public class FixedUpdateManager : MonoSingleton<FixedUpdateManager>
    {
        private readonly HashSet<IFixedUpdateObserver> _observers = new();
        private readonly HashSet<IFixedUpdateObserver> _pendingObservers = new();
        private readonly HashSet<IFixedUpdateObserver> _pendingRemovals = new();
