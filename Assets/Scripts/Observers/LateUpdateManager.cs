...
{
    public class LateUpdateManager : MonoSingleton<LateUpdateManager>
    {
        private readonly HashSet<ILateUpdateObserver> _observers = new();
        private readonly HashSet<ILateUpdateObserver> _pendingObservers = new();
        private readonly HashSet<ILateUpdateObserver> _pendingRemovals = new();
